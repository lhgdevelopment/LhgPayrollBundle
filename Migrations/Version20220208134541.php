...
final class Version20220208134541 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lhg_payroll_approval_history (id INT AUTO_INCREMENT NOT NULL, approval_id INT NOT NULL, user_id INT NOT NULL, status_id INT NOT NULL, date DATETIME NOT NULL COMMENT \'(DC2Type:datetime)\', INDEX IDX_A8341CE3FE65F000 (approval_id), INDEX IDX_A8341CE3A76ED395 (user_id), INDEX IDX_A8341CE36BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
